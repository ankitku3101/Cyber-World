    ...
    return (
        ...
        <div className="space-y-6 justify-between text-gray-600 md:flex flex-row-reverse md:gap-6 md:space-y-0 lg:gap-12 lg:items-center">
            ...
            <div className="divide-y space-y-4 divide-gray-100 dark:divide-gray-800">
                ...
                <div className="w-5/6">
                    <h3 className="font-semibold text-lg text-gray-700 dark:text-indigo-300">Get in touch with us</h3>
                    <p className="text-gray-500 dark:text-gray-400">We generally respond within 1-2 working days</p>
                </div> 
                </div> 
                ...
                <div className="w-5/6">
                    <h3 className="font-semibold text-lg text-gray-700 dark:text-teal-300">Dehradun, Uttarakhand</h3>
