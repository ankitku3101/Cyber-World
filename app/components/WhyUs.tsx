    ...
    return (
        <div className="bg-black">
            <section id="features" className="relative block px-6 py-10 md:py-20 md:px-10 bg-black">
                ...
                <div className="absolute bottom-0 left-0 z-0 h-1/3 w-full border-b bg-black border-black"></div>
                <div className="absolute bottom-0 right-0 z-0 h-1/3 w-full bg-black border-black"></div>
            </section>
        </div>
    );
}
