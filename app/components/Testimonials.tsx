...
<section className="mx-40 my-5">
  <div className="mx-auto max-w-screen-2xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
    ...
    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3">
      <blockquote className="flex h-full flex-col justify-between bg-black p-6 shadow-sm sm:p-8 border border-gray-500 rounded-xl ">
        <div>
          ...
          <div className="mt-4">
            ...
            <p className="mt-4 leading-relaxed text-gray-300">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste, tempore. Quibusdam aliquid veritatis neque consequuntur beatae maiores! Voluptate aliquid eos deserunt id expedita quae iusto, ipsum culpa aspernatur, quasi neque!
            </p>
          </div>
        </div>
